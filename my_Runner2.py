...
def SpinUp(params, run_name, load_name):
    ...
    h[np.where(np.logical_and(np.logical_and(md.mesh.y<17800, md.mesh.y>12200), np.logical_and(md.mesh.x<50000, md.mesh.x>18000)))]=100
...
def extenddomain(params, run_name, load_name):
    ...
    h[np.where(np.logical_and(md.geometry.bed<1200, np.logical_and(md.mesh.x<70000, md.mesh.x>20000)))]=100
