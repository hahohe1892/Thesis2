...
def insertatinflux(params, run_name, load_name):
    restart_time=50
    y_dim, x_dim, slope, dc, gap_halfwidth, step = standardvalues()
    start_icefront=params['start_icefront']
    slab_thickness=params['slab_thickness']
    ...
    insert_over=np.where(md.mesh.x>10000)
    insert_under=np.where(md.mesh.x<10000)

    md.geometry.bed=InterpFromMeshToMesh2d(old_mesh_elements, old_mesh_x, old_mesh_y, old_mesh_geometry, md.mesh.x, md.mesh.y)[0][:,0]+null_level

    md.geometry.thickness=2000*np.ones(md.mesh.numberofvertices)
    md.geometry.thickness[insert_over]=InterpFromMeshToMesh2d(md2.mesh.elements, md2.mesh.x+10000, md2.mesh.y, md2.results.TransientSolution[restart_time].Thickness, md.mesh.x[insert_over], md.mesh.y[insert_over])[0][:,0]
    ...
    md.mask.groundedice_levelset[insert_over]=InterpFromMeshToMesh2d(md2.mesh.elements, md2.mesh.x+10000, md2.mesh.y, md2.results.TransientSolution[restart_time].MaskGroundediceLevelset, md.mesh.x[insert_over], md.mesh.y[insert_over])[0][:,0]

    md.initialization.pressure=np.ones(md.mesh.numberofvertices)
    md.initialization.pressure[insert_over]=InterpFromMeshToMesh2d(md2.mesh.elements, md2.mesh.x+10000, md2.mesh.y, md2.results.TransientSolution[restart_time].Pressure, md.mesh.x[insert_over], md.mesh.y[insert_over])[0][:,0]
...
#    md.geometry.base=md.geometry.bed
    ...
    md.geometry.base[insert_over]=InterpFromMeshToMesh2d(md2.mesh.elements, md2.mesh.x+10000, md2.mesh.y, md2.results.TransientSolution[restart_time].Base, md.mesh.x[insert_over], md.mesh.y[insert_over])[0][:,0]
    md.geometry.base[insert_under]=md.geometry.bed[insert_under]

    md.geometry.surface=2000*np.ones(md.mesh.numberofvertices)
    md.geometry.surface[insert_over]=InterpFromMeshToMesh2d(md2.mesh.elements, md2.mesh.x+10000, md2.mesh.y, md2.results.TransientSolution[restart_time].Surface, md.mesh.x[insert_over], md.mesh.y[insert_over])[0][:,0]
    ...
    md.initialization.vx=params['spcvx']*np.ones(md.mesh.numberofvertices)
    md.initialization.vx[insert_over]=InterpFromMeshToMesh2d(md2.mesh.elements, md2.mesh.x+10000, md2.mesh.y, md2.results.TransientSolution[restart_time].Vx, md.mesh.x[insert_over], md.mesh.y[insert_over])[0][:,0]
    md.initialization.vy=np.zeros(md.mesh.numberofvertices)
    md.initialization.vy[insert_over]=InterpFromMeshToMesh2d(md2.mesh.elements, md2.mesh.x+10000, md2.mesh.y, md2.results.TransientSolution[restart_time].Vy, md.mesh.x[insert_over], md.mesh.y[insert_over])[0][:,0]
